...
void ADC_init (void) {
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 |= (3UL<<30); //Potentiometer connected to pin 1.31 which corresponds to AD0.5 that's why I'm selecting as the function of the PIN

  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1<<12); //Enable power

  ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADCR = (1<< 5) | //we are in software mode: so only 1 channel allowed: I select AD0.5 for the potentiometer
