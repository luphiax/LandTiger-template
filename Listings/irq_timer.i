...
void TIMER2_IRQHandler (void)
{
                    //LOUDSPEAKER(DAC)
 static int ticks=0;
 ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->DACR = (SinTable[ticks]<<6); //For each tick of k length of the timer (with k depending on the frequency) convert into analog a sampled point of the sinusoid
 ticks++;
...
//case KEY2
  ...
  down_KEY2++;
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<12)) == 0){ //int0
   //222 reset_timer(3)
   switch(down_KEY2){
    case 1:
