...
void BUTTON_init(void) {
 ...
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1 << 21);

  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= ~(1 << 10); //clear bit for input mode (default)

 //external interrupt configuration for KEY1
 //input pin(default) + 01 config --> interrupt

  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |= (1 << 22);
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1 << 23);
 ...
 //input pin(default) + 01 config --> interrupt
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1 << 25);
 ...
 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTPOLAR = 0;
