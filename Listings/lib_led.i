...
void LED_init(void) {
 ...
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(
  (3u << 0) // P2.0
 | (3u << 2) // P2.1
 | (3u << 4) // P2.2
 | (3u << 6) // P2.3
 ...
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |=
  (1u << 0) // P2.0
 | (1u << 1) // P2.1
 | (1u << 2) // P2.2
 | (1u << 3) // P2.3
 ...
 | (1u << 5) // P2.5
 | (1u << 6) // P2.6
 | (1u << 7); // P2.7 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= 0x000000FF;
# 58 "Source/led/lib_led.c"
 // all LEDs off on P2.0...P2.7
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR =
  (1u << 0)
 | (1u << 1)
 | (1u << 2)
 | (1u << 3)
 ...
 | (1u << 5)
 | (1u << 6)
 | (1u << 7); //((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0x000000FF;
 led_value = 0;
}
...
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= ~(
 ...
 | (1u << 5) // P2.5
 | (1u << 6) // P2.6
 | (1u << 7) // P2.7 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= 0xFFFFFF00;
 );
