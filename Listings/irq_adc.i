...
# 41 "Source/adc/IRQ_adc.c"
const int freqs[8]={2120,1890,1684,1592,1417,1263,1125,1062}; //in reality these are the periods
# 54 "Source/adc/IRQ_adc.c"
void ADC_IRQHandler(void) {
               //POTENTIOMETER(ADC)

  AD_current = ((((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADGDR>>4) & 0xFFF);// I access the result from the converted value register
