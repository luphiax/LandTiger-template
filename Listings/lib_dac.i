# 1 "Source/dac/lib_dac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 404 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/dac/lib_dac.c" 2
...
# 2 "Source/dac/lib_dac.c" 2
# 1 "Source/dac\\dac.h" 1
void DAC_init (void);
# 3 "Source/dac/lib_dac.c" 2
...
void DAC_init (void) {
   ...
   ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &= ~(1<<20); //I set the pin 0.26 to aout(DAC) config 10
   ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<26); //need it for software debugging
}
