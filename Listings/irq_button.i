...
void EINT0_IRQHandler (void)
{
 ...
 __NVIC_DisableIRQ(EINT0_IRQn);
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<20); //deve essere 00 per GPIO out
...
void EINT1_IRQHandler (void)
{
 ...
 __NVIC_DisableIRQ(EINT1_IRQn);
  //lo cambio in GPIO output
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<22); //deve essere 00 per GPIO out
...
void EINT2_IRQHandler (void)
{
 ...
 __NVIC_DisableIRQ(EINT2_IRQn);
  //lo cambio in GPIO output
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= ~(1<<24); //deve essere 00 per GPIO out
